...
import engagementinvitation from "../../Assets/Projects/engagementinvitation.png";
    ...
    <Container fluid className="project-section">
      ...
      <Container>
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={engagementinvitation}
              isBlog={false}
              title="Engagement Invitation"
              description="A modern web-based engagement invitation designed for my brother’s special 
              day, transforming a traditional invitation into an interactive digital experience. The
               application features a cinematic intro screen, real-time countdown, animated falling 
               petals, and background music to create an immersive and memorable experience for guests
               . With a clean interface and elegant design, the website ensures smooth performance and
                responsiveness across all devices, delivering both aesthetic appeal and functional 
                interactivity."
              ghLink="https://github.com/Rashad012/engagement-invitation"
              demoLink="https://engagementinvitation-rashad2815.netlify.app/"              
            />
          </Col>
        </Row>
      </Container>
